 ...
 */
    self.addStyleSheet = function () {
        var ss = document.createElement("style"),
            rules =
                ".regex-color       {font-family: Monospace;} " +
                ".regex-color b     {background: #aad1f7;} " + // metasequence
                ".regex-color i     {background: #e3e3e3;} " + // char class
                ".regex-color i b   {background: #9fb6dc;} " + // char class: metasequence
                ".regex-color i u   {background: #c3c3c3;} " + // char class: range-hyphen
                ".regex-color b.g1  {background: #b4fa50; color: #000;} " + // group: depth 1
                ".regex-color b.g2  {background: #8cd400; color: #000;} " + // group: depth 2
                ".regex-color b.g3  {background: #26b809; color: #fff;} " + // group: depth 3
                ".regex-color b.g4  {background: #30ea60; color: #000;} " + // group: depth 4
                ".regex-color b.g5  {background: #0c8d15; color: #fff;} " + // group: depth 5
                ".regex-color b.err {background: #e30000; color: #fff;} " + // error
                ".regex-color b, .regex i, .regex u {font-weight: normal; font-style: normal; text-decoration: none;}";
